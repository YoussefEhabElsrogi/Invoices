...
@section('title')
    تعديل قسم {{ $section->section_name }}
@stop
        ...
        <div class="col-md-6">
            <div class="card box-shadow-0">
                <div class="card-header">
                    <h4 class="card-title mb-1">تعديل قسم {{ $section->section_name }}</h4>
                </div>
                <div class="card-body pt-0">
                    <form class="form-horizontal" action="{{ route('sections.update', ['section' => $section]) }}"
